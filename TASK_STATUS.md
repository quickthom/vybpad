...
| 8.1 | QA | phase-8/coverage-audit-matrix | in-review | [#77](https://github.com/quickthom/vybpad/pull/77) | None | `docs/TEST_COVERAGE_MATRIX.md`; **TASK-6.6** = HITL row; P0/P1 gaps cross-ref TASK-8.2–8.4 |
