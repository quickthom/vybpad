...
| 8.1 | QA | phase-8/coverage-audit-matrix | in-review | — | None | `docs/TEST_COVERAGE_MATRIX.md` on branch (commit `3c6a473`); **TASK-6.6** = HITL row; P0/P1 gaps cross-ref TASK-8.2–8.4 — open PR vs `develop` |
