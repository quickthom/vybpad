...
**Status:** active — Wave 2: TASK-7.3 in progress.
...
| 7.3 | Builder | `phase-7/split-tie-triplet` | in-progress | — | 7.2, 7.1, 2.1 | split / tie / triplet; worktree `…/phase-7-split-tie-triplet` |
