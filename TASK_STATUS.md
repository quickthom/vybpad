...
**Status:** active — Wave 2: TASK-7.4 merged; TASK-7.5 next (navigation / playback shortcuts).
...
| 7.5 | Builder | — | pending | — | 7.1, 7.4 | zoom / scroll / selection / playback shortcuts (EditorLayout + registry) |
