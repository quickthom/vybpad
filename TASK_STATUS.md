...
**Status:** active — Wave 2: TASK-7.5 in progress (navigation / playback shortcuts).
...
| 7.5 | Builder | phase-7/navigation-shortcuts | in-progress | — | 7.1, 7.4 | zoom / scroll / selection / playback shortcuts |
